      ...
      <div class="panel-heading">Share Scores</div>
        <div style="float:left">
          ...
          <a class="twitter-share-button"
            href="https://twitter.com/intent/tweet?text={{ $game->team1 }} {{ $row->totalGoal }} {{ $game->team2 }} {{ $row2->totalGoal }} #scorehub #omg"
            data-size="large">
          </a>
        </div>
...
function myFacebookLogin() {
  FB.login(function(){
     FB.api('/me/feed', 'post', {message: '{{ $game->team1 }} {{ $row->totalGoal }} {{ $game->team2 }} {{ $row2->totalGoal }} #scorehub #omg'});
